...
interface NFTMarketInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "showAll", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "showAll", data: BytesLike): Result;
...
export class NFTMarket extends BaseContract {
  ...
  estimateGas: {
    ...
    showAll(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    showAll(overrides?: CallOverrides): Promise<PopulatedTransaction>;
